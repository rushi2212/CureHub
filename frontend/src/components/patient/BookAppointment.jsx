...
const BookAppointment = () => {
  ...
  if (loading) {
    return (
      <div className="bg-white rounded-xl shadow-xl p-4 md:p-8 animate-pulse">
        <div className="h-8 md:h-10 bg-gray-200 rounded-lg w-full md:w-3/4 mb-4 md:mb-8"></div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
          <div className="space-y-4 md:space-y-6">
            <div className="h-10 md:h-12 bg-gray-200 rounded-lg w-full mb-2 md:mb-4"></div>
            <div className="space-y-2">
              {[...Array(3)].map((_, i) => (
                <div
                  key={i}
                  className="h-16 md:h-20 bg-gray-200 rounded-lg w-full"
                ></div>
              ))}
            </div>
          </div>
          <div className="space-y-4 md:space-y-6 mt-4 md:mt-0">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-3">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="h-8 md:h-10 bg-gray-200 rounded-lg"></div>
              ))}
            </div>
            <div className="h-24 md:h-32 bg-gray-200 rounded-lg w-full mt-4 md:mt-6"></div>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="bg-white rounded-xl shadow-xl p-4 md:p-8 animate-fadeIn">
        <div className="flex flex-col items-center text-center mb-4 md:mb-8">
          <div className="w-16 h-16 md:w-24 md:h-24 bg-green-100 rounded-full flex items-center justify-center mb-4 md:mb-6">
            <CheckCircle size={isMobile ? 32 : 48} className="text-green-600" />
          </div>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-indigo-50 p-4 md:p-6 rounded-xl border border-indigo-100 mb-6 md:mb-8 w-full max-w-md">
            <div className="flex items-center mb-4">
              <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-indigo-100 flex items-center justify-center mr-3 md:mr-4">
                <User size={isMobile ? 20 : 28} className="text-indigo-600" />
              </div>
              <div className="text-left">
                <h3 className="font-bold text-lg md:text-xl">
                  {selectedDoctorData?.name || "Doctor"}
                </h3>
                <p className="text-indigo-600 text-sm md:text-base">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
              <div className="bg-white p-3 md:p-4 rounded-lg shadow-sm">
                <div className="flex items-center text-gray-700 mb-1">
                  <Calendar size={isMobile ? 14 : 16} className="mr-1 md:mr-2 text-indigo-500" />
              ...
              <div className="bg-white p-3 md:p-4 rounded-lg shadow-sm">
                <div className="flex items-center text-gray-700 mb-1">
                  <Clock size={isMobile ? 14 : 16} className="mr-1 md:mr-2 text-indigo-500" />
                  <span className="text-xs md:text-sm font-medium">Time</span>
                </div>
                <p className="font-medium text-sm md:text-base">{selectedSlot}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 w-full max-w-md">
            <button
              ...
              className="px-4 md:px-6 py-2 md:py-3 bg-indigo-100 hover:bg-indigo-200 text-indigo-700 rounded-xl flex items-center justify-center transition-all text-sm md:text-base w-full"
            >
            ...
            <button
              ...
              className="px-4 md:px-6 py-2 md:py-3 bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white rounded-xl flex items-center justify-center transition-all text-sm md:text-base w-full mt-2 sm:mt-0"
            >
              <Calendar size={isMobile ? 16 : 20} className="mr-2" />
              Book Another
            </button>
...
// Show doctor comparison view
      ...
      <div className="bg-white rounded-xl shadow-xl p-4 md:p-8 animate-fadeIn">
        ...
        <div
          className={`grid grid-cols-1 ${
            selectedDoctorsData.length === 3 ? "md:grid-cols-3" : "md:grid-cols-2"
          } gap-4 mb-8`}
        >
            ...
            >
              <div className="p-4 border-b border-indigo-100 bg-indigo-50">
                <div className="flex justify-between items-start mb-2">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-indigo-200 flex items-center justify-center">
                  ...
                  <button
                    ...
                    className="px-2 py-1 sm:px-3 sm:py-1 bg-indigo-600 text-white text-xs sm:text-sm rounded-full hover:bg-indigo-700"
                  >
                    Select
                  </button>
                </div>
              ...
              <div className="p-4">
                ...
                <div className="mb-3">
                  ...
                  <div className="font-medium text-sm">${doctor.fee || "85"}</div>
                </div>

                <div className="mb-3">
                  <div className="text-xs sm:text-sm text-gray-600 mb-1">Experience</div>
                  <div className="font-medium text-sm">
        ...
        <div className="text-center">
          <button
            onClick={() => setView("default")}
            className="px-4 sm:px-6 py-2 sm:py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-all text-sm sm:text-base"
          >
            Return to Booking
          </button>
        </div>
  ...
  return (
    <div className="bg-white rounded-xl shadow-xl p-4 md:p-8 animate-fadeIn">
      <h2 className="text-xl md:text-3xl font-bold text-indigo-800 mb-4 md:mb-6 flex items-center">
        <Calendar className="mr-2 md:mr-3 text-indigo-600" size={24} />
      ...
      <div className="flex flex-wrap gap-2 sm:gap-3 mb-4 md:mb-6">
        <button
          ...
          className="flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-green-600 text-white text-sm rounded-lg hover:bg-green-700 transition-all"
        >
        ...
        {doctorsToCompare.length > 0 && (
          <button
            ...
            className="flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-indigo-100 text-indigo-700 text-sm rounded-lg hover:bg-indigo-200 transition-all"
          >
      ...
      {selectedDoctor && selectedSlot && (
        <div className="fixed bottom-0 left-0 right-0 bg-indigo-800 text-white py-2 sm:py-3 px-3 sm:px-4 z-20 shadow-lg">
          <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between sm:items-center gap-2 sm:gap-0">
            <div className="flex items-center">
              <CheckCircle size={16} className="mr-1 sm:mr-2 text-green-400 flex-shrink-0" />
            ...
            <button
              ...
              className="px-3 sm:px-4 py-1.5 sm:py-2 bg-green-500 text-white text-sm rounded-lg hover:bg-green-600 transition-all flex items-center justify-center sm:justify-start"
            >
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="border-2 border-gray-200 rounded-xl overflow-hidden">
              <button
                ...
                className="w-full p-3 sm:p-4 flex justify-between items-center bg-gray-50 hover:bg-gray-100"
              >
                <div className="flex items-center">
                  <Search size={18} className="mr-2 text-indigo-600" />
                  <span className="font-medium text-sm sm:text-base">Find a Doctor</span>
                </div>
            ...
            <div className="border-2 border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="font-medium text-sm sm:text-base">Select Doctor</span>
                  {selectedDoctor && (
            ...
            >
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="font-medium text-sm sm:text-base">Select Date & Time</span>
                  {selectedSlot && (
                    <CheckCircle size={14} className="ml-2 text-green-500" />
                  )}
                </div>
            ...
            <div className="border-2 border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="font-medium text-sm sm:text-base">Symptoms / Reason</span>
                  {symptoms && (
                    <CheckCircle size={14} className="ml-2 text-green-500" />
                  )}
                </div>
            ...
            <button
              ...
              className={`w-full py-2.5 sm:py-3 rounded-xl text-white font-medium flex items-center justify-center mt-4 md:mt-6 text-sm sm:text-base
                ${
                  !selectedDoctor ||
                  !selectedSlot ||
                  !symptoms ||
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <button
                ...
                className={`w-full py-2.5 sm:py-3 rounded-xl text-white font-medium flex items-center justify-center mt-4 text-sm sm:text-base
                  ${
                    !selectedDoctor ||
                    !selectedSlot ||
                    !symptoms ||
      ...
      {showConfirmModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-3 sm:p-4">
          <div className="bg-white rounded-xl shadow-xl p-4 sm:p-6 max-w-md w-full animate-scaleIn">
            ...
            <div className="mb-4 sm:mb-6">
              ...
              <div className="bg-gray-50 p-3 sm:p-4 rounded-lg mb-3 sm:mb-4 text-sm">
                <div className="mb-2">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              <button
                ...
                className="py-2 px-3 sm:px-4 border border-gray-300 rounded-lg hover:bg-gray-100 flex-1 text-sm sm:text-base"
              >
                Cancel
              </button>
              <button
                onClick={confirmBooking}
                className="py-2 px-3 sm:px-4 bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white rounded-lg flex-1 text-sm sm:text-base"
              >
                Confirm
              </button>
            </div>
      ...
      <div className="relative mb-3 sm:mb-4">
        <div className="relative">
          <input
            ...
            className="w-full p-2.5 sm:p-3 pr-10 sm:pr-12 border-2 border-gray-200 rounded-lg focus:border-indigo-500 focus:outline-none text-sm sm:text-base"
          />
          <div className="absolute inset-y-0 right-0 flex items-center px-2 sm:px-3">
          ...
          <div className="absolute z-10 w-full mt-1 bg-white rounded-lg shadow-lg border border-gray-200">
            {searchSuggestions.map((suggestion) => (
              <button
                ...
                className="w-full p-2.5 sm:p-3 text-left hover:bg-indigo-50 flex items-center border-b border-gray-100 last:border-none"
              >
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-indigo-100 flex items-center justify-center mr-2 sm:mr-3">
                  <User size={14} className="text-indigo-600" />
                </div>
                <div>
                  <div className="font-medium text-sm sm:text-base">{suggestion.text}</div>
